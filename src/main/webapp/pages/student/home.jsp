                        ...
                        <div class="timeline timeline-one-side">
                            <div class="timeline-block mb-3">
                                ...
                                <div class="timeline-content">
                                    <h6 class="text-dark text-sm font-weight-bold mb-0">Maths</h6>
                            ...
                            <div class="timeline-block mb-3">
                                ...
                                <div class="timeline-content">
                                    <h6 class="text-dark text-sm font-weight-bold mb-0">Science</h6>
                                    <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">22 DEC 7:20 PM</p>
                                    <span class="badge badge-sm bg-gradient-warning">Absent</span>
                                </div>
                            </div>
                        </div>
                    </div>
